///////////////////////////////////////////////////////////////////////////////////////////
// 文件名：TranslateDownXMLForRADIO.cpp
// 创建者：gaoxd
// 创建时间：2010-04-09
...
//返回标准的实时视频任务XML
bool TranslateDownXMLForRADIO::TranslateStreamRealtimeQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	...
	if(!strcmp(downType.c_str(),"RadioDown"))
	{
		downType="RADIO";
	}
	else
...
//返回标准的录像设置任务XML
bool TranslateDownXMLForRADIO::TranslateRecordSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	...
	if(strOriginalXML.find("SetAutoRecordChannel")!=string::npos)		//自动录音设置
	{
		...
		for (int i=0;i<autoRecordList->Size();++i)
		{
			...
			for (int j=0;j<nodeList->Size();++j)
			{
				...
				PROPMANAGER::instance()->GetDeviceIndex(Index,DeviceID,"RADIO");
				...
				if(Code!="")
				   CHANNELINFOMGR::instance()->GetFreqByChannelCode(RADIO,Code,Freq);			
	...
	else		//录音任务设置
	{
		...
		else		//录音任务设置
		{
			...
			for (int i=0;i!=nodelist->Size();++i)
			{
				...
				if (ChCode!="")
				{
					CHANNELINFOMGR::instance()->GetFreqByChannelCode(RADIO,ChCode,Freq);
				}
...
//返回标准的录像执行任务XML
bool TranslateDownXMLForRADIO::TranslateRecordTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
	//录音标准的XML结构
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser( strOriginalXML.c_str());
...
//返回标准的录像查询、下载XML
bool TranslateDownXMLForRADIO::TranslateRecordQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	//初始化属性值
	...
	else if(nodeName=="TaskRecordFileQuery" || nodeName=="RecordFileQuery")
	{
	...
	if (strType =="RadioDown")
	{
		tempParser.SetAttrNode("DVBType",string("RADIO"),tempRootNode);           //设置Msg节点的DVBType属性值
	}
	else
	{
		return false;
...
//返回标准的频谱扫描XML
bool TranslateDownXMLForRADIO::TranslateSpectrumScanQuery( const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser( strOriginalXML.c_str());
	XmlParser tempParser( source );
	...
	//初始化属性值
	string EquCode,StartFreq,EndFreq,StepFreq,Steps,Action,ReferDbu,VBW,RBW;
	try
	{	
		//获取频谱扫描各属性
		parser.GetAttrNode( realStreamNode,"EquCode",EquCode );
...
//返回标准的实时指标查询XML
bool TranslateDownXMLForRADIO::TranslateQualityRealtimeQuery( const std::string& strOriginalXML,std::string& strStandardXML)
{
...
bool TranslateDownXMLForRADIO::TranslateChannelScanQuery( const std::string& strOriginalXML,std::string& strStandardXML )
{
	string downType;//定义检测类型
...
bool TranslateDownXMLForRADIO::TranslateStreamRound( const std::string& strOriginalXML,std::string& strStandardXML )
{
...
//wz_110125
bool TranslateDownXMLForRADIO::TranslateChannelSet( const std::string& strOriginalXML,std::string& strStandardXML )
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser( strOriginalXML.c_str());
	XmlParser tempParser( source );
	...
	if (strType =="RadioDown")
	{
		strType = "RADIO";          //设置Msg节点的DVBType属性值
	}
	else
	{
		return false;
...
bool TranslateDownXMLForRADIO::TranslateAlarmParamSet( const std::string& strOriginalXML,std::string& strStandardXML )
{
	...
	for(int i=0;i<count;i++)
	{
		...
		{
			CHANNELINFOMGR::instance()->GetFreqByChannelCode(RADIO,channelcode,freq);
		}
		else
		{
			freq="All";
...
//返回标准的定时指标设置任务xml
bool TranslateDownXMLForRADIO::TranslateQualityTaskSet(const std::string& strOriginalXML,std::string& strStandardXML)
{  
...
//返回标准的定时指标执行任务xml
bool TranslateDownXMLForRADIO::TranslateQualityTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
	size_t pos;
...
//返回标准的定时指标设置任务xml
bool TranslateDownXMLForRADIO::TranslateSpectrumTaskSet(const std::string& strOriginalXML,std::string& strStandardXML)
{  
	std::string strVersion,strMsgID,strType,strTaskType,strProtocol,strSetDateTime,strSrcCode,strDstCode,strSrcURL,strPriority;
	std::string TaskID, Action,EquCode,IsFreqScan,StartFreq,EndFreq,StepFreq,Code,SpectrumAnalyse,ReferDbu,VBW,RBW;
...
bool TranslateDownXMLForRADIO::TranslateSpectrumTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
	size_t pos;
	std::string orgXML = strOriginalXML;
	std::vector<std::string> timeIndexVct;
	...
	for (size_t p=0;p<timeIndexVct.size();++p)
	{
		std::string tmpstr=orgXML;
		std::string strVersion,strMsgID,strType,strTaskType,strProtocol,strSetDateTime,strSrcCode,strDstCode,strSrcURL,strPriority;
		std::string TaskID, Action,DevideID,EquCode,IsFreqScan,StartFreq,EndFreq,StepFreq,SpectrumAnalyse,ReferDbu,VBW,RBW;
...
bool TranslateDownXMLForRADIO::TranslateSpectrumQueryTask(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	...
	retparser.SetAttrNode("DVBType",string("RADIO"),retRootNode);               //设置Msg节点的DVBType属性值
...
bool TranslateDownXMLForRADIO::TranslateQualityQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
	...
	//gxd 2011.02.22 适应不用的页面系统接口
	if (ChannelCode.length() == 0 || ChannelCode.empty() == true)
...
bool TranslateDownXMLForRADIO::TranslateClientInfoQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
...
//返回标准的运行图设置任务xml
bool TranslateDownXMLForRADIO::TranslateRunPlanSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
bool TranslateDownXMLForRADIO::TranslateStopClient(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
...
bool TranslateDownXMLForRADIO::TranslateTaskSchedulerQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
...
bool TranslateDownXMLForRADIO::TranslateManualTaskSchedulerQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
...
bool TranslateDownXMLForRADIO::TranslateEquipmentAlarmParamSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg><AlarmParamSet></AlarmParamSet></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
...
bool TranslateDownXMLForRADIO::TranslateInfoCheckRequest(const std::string& strOriginalXml, std::string& strStandardXml)
{
	...
	retparser.SetAttrNode("DVBType",string("RADIO"),retRootNode);              
...
bool TranslateDownXMLForRADIO::TranslateRunPlanCheck(const std::string& strOriginalXml, std::string& strStandardXml)
{
	...
	stdParser.SetAttrNode("DVBType",string("RADIO"),stdMsgNode);              
...
bool TranslateDownXMLForRADIO::TranslateAlarmExpireTask(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser retparser(source);
