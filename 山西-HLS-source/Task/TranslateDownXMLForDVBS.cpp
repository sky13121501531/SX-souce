///////////////////////////////////////////////////////////////////////////////////////////
// 文件名：TranslateDownXMLForDVBS.cpp
// 创建者：jiangcheng
// 创建时间：2009-06-04
...
//返回标准的频道扫描任务XML
bool TranslateDownXMLForDVBS::TranslateChannelScan(const std::string& strOriginalXML,std::string& strStandardXML)
{
	//频道扫描标准的XML结构
	...
	if(!strcmp(downType.c_str(),"SatDown"))
	{
		downType="DVBS";
	}
	else
...
//返回标准的实时视频任务XML
bool TranslateDownXMLForDVBS::TranslateStreamRealtimeQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	//视频查询标准的XML结构
	...
	//获取OrgNetID,tsID
	CHANNELINFOMGR::instance()->GetOrgNetID(DVBS,freq,audioPID,videoPID,serviceID,OrgNetID );
	CHANNELINFOMGR::instance()->GetTsID(DVBS,freq,audioPID,videoPID,serviceID,tsID);
...
//返回标准的视频轮播任务XML
bool TranslateDownXMLForDVBS::TranslateStreamRoundQuery(const std::string& strOriginalXML,std::string& strStandardXML,bool multi)
{
	//视频查询标准的XML结构
...
//返回标准的录像设置任务XML
bool TranslateDownXMLForDVBS::TranslateRecordSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	...
	if(strOriginalXML.find("SetAutoRecordChannel")!=string::npos)
	{
		...
		for (int i=0;i<autoRecordList->Size();++i)
		{
			...
			for (int j=0;j<nodeList->Size();++j)
			{
				...
				PROPMANAGER::instance()->GetDeviceIndex(DeviceID,Index,"DVBS");
...
//返回标准的录像执行任务XML
bool TranslateDownXMLForDVBS::TranslateRecordTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
	//录像标准的XML结构
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser( strOriginalXML.c_str());
...
//返回标准的录像查询、下载XML
bool TranslateDownXMLForDVBS::TranslateRecordQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	//初始化属性值
	...
	if (strType =="SatDown")
	{
		tempParser.SetAttrNode("DVBType",string("DVBS"),tempRootNode);           //设置Msg节点的DVBType属性值
	}
	else
	{
		return false;
	...
	if ( (nodeName.compare("AutoRecordFileQuery") == 0)||(nodeName.compare("AutoRecordQuery") == 0) )
	{
		...
		PROPMANAGER::instance()->GetDeviceIndex(DeviceID,DeviceID,"DVBS");	//将逻辑通道转化为实际通道
...
//返回标准的偱切录像设置任务XML
bool TranslateDownXMLForDVBS::TranslateRoundRecordSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
...
//返回标准的偱切录像执行任务XML
bool TranslateDownXMLForDVBS::TranslateRoundRecordTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
...
//返回标准的实时指标查询XML
bool TranslateDownXMLForDVBS::TranslateQualityRealtimeQuery( const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回标准的定时指标设置任务xml
bool TranslateDownXMLForDVBS::TranslateQualityTaskSet(const std::string& strOriginalXML,std::string& strStandardXML)
{  
...
//返回标准的定时指标执行任务xml
bool TranslateDownXMLForDVBS::TranslateQualityTask(const std::string& strOriginalXML,std::vector<std::string>& strStandardXMLVec)
{
	size_t pos;
...
//返回标准的定时指标结果查询任务xml
bool TranslateDownXMLForDVBS::TranslateQualityQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	std::string strVersion,strMsgID,strType,strTaskType,strProtocol,strSetDateTime,strSrcCode,strDstCode,strSrcURL,strPriority;
...
//返回标准的频道设置任务xml
bool TranslateDownXMLForDVBS::TranslateChannelSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser( strOriginalXML.c_str());
	XmlParser tempParser( source );
	...
	if (strType =="SatDown")
	{
		strType = "DVBS";          //设置Msg节点的DVBType属性值
	}
	else
	{
		return false;
...
//返回标准的客户信息查询任务xml
bool TranslateDownXMLForDVBS::TranslateClientInfoQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回标准的通道状态查询任务xml
bool TranslateDownXMLForDVBS::TranslateDeviceStatusQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回标准的表查询任务xml
bool TranslateDownXMLForDVBS::TranslateTableQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回标准的运行图设置任务xml
bool TranslateDownXMLForDVBS::TranslateRunPlanSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	...
	pXMLNODELIST orgChannelIndexList = parser.GetNodeList( orgRootNode );
	...
	for ( int j = 0;j< count;j++ )
	{
		if ( j == 0 )
		{
			orglistNode = parser.GetFirstNode( orgChannelIndexList );
		}
		else
		{
	...
	try
	{
		...
		for ( int j = 0;j< count;j++ )
		{
			...
			parser.GetAttrNode(orglistNode,"Freq",Freq);
			parser.GetAttrNode(orglistNode,"ServiceID",ServiceID);
			parser.GetAttrNode(orglistNode,"VideoPID",VideoPID);
			parser.GetAttrNode(orglistNode,"AudioPID",AudioPID);
			...
			{
				string Month,Day,DayOfWeek,StartTime,EndTime,ValidStartDateTime,ValidEndDateTime,StartDateTime,EndDateTime;
				...
				if(parser.GetNodeName(childListNode)=="MonthTime")
				{
					parser.GetAttrNode(childListNode,"Month",Month);
					parser.GetAttrNode(childListNode,"Day",Day);
					parser.GetAttrNode(childListNode,"StartTime",StartTime);
					parser.GetAttrNode(childListNode,"EndTime",EndTime);

				}
				else if(parser.GetNodeName(childListNode)=="WeeklyTime")
				{
					parser.GetAttrNode(childListNode,"StartTime",StartTime);
					parser.GetAttrNode(childListNode,"EndTime",EndTime);
				}
				else if(parser.GetNodeName(childListNode)=="DayTime")
				{
...
//返回标准的手动录制任务xml
bool TranslateDownXMLForDVBS::TranslateManualRecordSet(const std::string &strOriginalXML, std::string &strStandardXML)
{
...
bool TranslateDownXMLForDVBS::TranslateAutoAnalysisTimeSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
bool TranslateDownXMLForDVBS::TranslateEPGQuery( const std::string& strOriginalXML,std::string& strStandardXML )
{
...
bool TranslateDownXMLForDVBS::TranslateMHPQuery( const std::string& strOriginalXML,std::string& strStandardXML )
{
...
//返回标准的环境指标查询任务xml
bool TranslateDownXMLForDVBS::TranslateEnvironmentQualityQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回标准的频谱扫描任务xml
bool TranslateDownXMLForDVBS::TranslateSpectrumScan(const std::string& strOriginalXML,std::string& strStandardXML)
{
...
//返回指标补偿标准xml
bool TranslateDownXMLForDVBS::TranslateQualityCompensationSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//返回报警参数设置标准xml
bool TranslateDownXMLForDVBS::TranslateAlarmParamSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	...
	for(int n=0;n<count;n++)
	{
		...
		for(int i=0;i<SetList->Size();i++)
		{
			...
			if(parser.GetNodeName(HoldNode)=="AlarmProgram")
			{
				...
				CHANNELINFOMGR::instance()->GetOrgNetID(DVBS,Freq,AudioPID,VideoPID,ServiceID,Netid);
				CHANNELINFOMGR::instance()->GetTsID(DVBS,Freq,AudioPID,VideoPID,ServiceID,Tsid);
				CHANNELINFOMGR::instance()->GetChannelID(DVBS,Netid,Tsid,ServiceID,VideoPID,AudioPID,"",Channelid);
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateAlarmReportSet( const std::string& strOriginalXML,std::string& strStandardXML )
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
	...
	strStandardXML.replace(firPos+1,7,"DVBS");
...
bool TranslateDownXMLForDVBS::TranslateAlarmQuery( const std::string& strOriginalXML,std::string& strStandardXML )
{
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateOSDSet( const std::string& strOriginalXML,std::string& strStandardXML )
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateStreamRealtimeRate(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateRecordCapabilityQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateHDDefAudioParamSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateAudioParamSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateClearAlarmState(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateMatrixQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
//wz_110107
bool TranslateDownXMLForDVBS::TranslateChangeQAMQuery(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
bool TranslateDownXMLForDVBS::TranslateLoopAlarmInfo(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
...
bool TranslateDownXMLForDVBS::TranslateRecordParamSet(const std::string& strOriginalXML,std::string& strStandardXML)
{
	char * source = "<?xml version=\"1.0\" encoding=\"GB2312\" standalone=\"yes\"?><Msg></Msg>";
	XmlParser parser(strOriginalXML.c_str());
	XmlParser temParser( source );
